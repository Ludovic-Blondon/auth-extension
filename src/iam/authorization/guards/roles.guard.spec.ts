  ...
  describe('handleRequest', () => {
    it('should return true if the user has the role', () => {
      ...
      const context = {
        ...
        getHandler: () => ({}),
        switchToHttp: () => ({
          getRequest: () => ({ [REQUEST_USER_KEY]: { role: Role.ADMIN } }),
        }),
      } as ExecutionContext;
      const result = new RolesGuard(reflector).canActivate(context);
    ...
    it('should return false if the user does not have the role', () => {
      ...
      const context = {
        ...
        getHandler: () => ({}),
        switchToHttp: () => ({
          getRequest: () => ({ [REQUEST_USER_KEY]: { role: Role.REGULAR } }),
        }),
      } as ExecutionContext;
      const result = new RolesGuard(reflector).canActivate(context);
